...
def train():
    ...
    wandb.config.update({'max_steps': max_steps})  # ref: https://docs.wandb.ai/guides/track/config#set-the-configuration-throughout-your-script
    # wand.config['max_steps'] = max_steps  # ref: https://docs.wandb.ai/guides/track/config#set-the-configuration-throughout-your-script
    ...
    final_ckpt_dir = output_dir / f'checkpoint-{max_steps}'
