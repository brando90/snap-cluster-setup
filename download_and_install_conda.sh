# RUN ALL THE INSTRUCTIONS! PLEASE! ref: https://github.com/brando90/ultimate-utils/blob/45d8b2f47ace4d09ea63fe7cca7a7822b3af2961/sh_files_repo/download_and_install_conda.sh#L1C1-L31C32
echo $HOME
# -- Install miniconda
